...
def get_or_create_address(
    ...
    address = Address.objects.create(
        ...
        line1=addr_dict.get('line1'),
        line2=addr_dict.get('line2'),
        city=addr_dict.get('city'),
        state=addr_dict.get('state'),
        zip=addr_dict.get('postal_code'),
        country=country_code,
        name='{} {}'.format(addr_dict.get('first_name'),
...
def match_address(customer: Customer, addr_dict: dict) -> Address:
    ...
    qs = Address.objects.filter(
        ...
        name__iexact='{} {}'.format(addr_dict.get('first_name', ''),
                                    addr_dict.get('last_name', '')).strip(),
        line1__iexact=addr_dict.get('line1'),
        line2__iexact=addr_dict.get('line2'),
